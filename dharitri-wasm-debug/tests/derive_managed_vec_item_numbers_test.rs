...
fn struct_with_numbers_static() {
    assert_eq!(
        <StructWithNumbers as dharitri_wasm::types::ManagedVecItem<DebugApi>>::PAYLOAD_SIZE,
        16
    );
    assert!(
        <StructWithNumbers as dharitri_wasm::types::ManagedVecItem<DebugApi>>::SKIPS_RESERIALIZATION
    );
}
...
fn struct_to_bytes_writer() {
    ...
    let mut arr: [u8; 16] =
        [0u8; <StructWithNumbers as dharitri_wasm::types::ManagedVecItem<DebugApi>>::PAYLOAD_SIZE];

    <StructWithNumbers as dharitri_wasm::types::ManagedVecItem<DebugApi>>::to_byte_writer(
        &s,
        |bytes| {
            arr[0..<StructWithNumbers as dharitri_wasm::types::ManagedVecItem<DebugApi>>::PAYLOAD_SIZE].copy_from_slice(bytes);
            assert_eq!(
                arr,
                [
...
fn struct_from_bytes_reader() {
    ...
    let struct_from_bytes =
        <StructWithNumbers as dharitri_wasm::types::ManagedVecItem<DebugApi>>::from_byte_reader(
            DebugApi::dummy(),
            |bytes| {
                bytes.copy_from_slice(
                    &arr
                        [0
                            ..<StructWithNumbers as dharitri_wasm::types::ManagedVecItem<
                                DebugApi,
                            >>::PAYLOAD_SIZE],
                );
            },
